...
reg [7:0]SPRBUF;
// Combinatorics
assign Do[7:0] = SPR_PPU ? SPRBUF[7:0] : 8'hZZ;
assign Reset = ~nRES;
...
SHIFT_REG LFSR[14:0] (Clk, {SOUT[13:0], LFSR_IN}, LFSTEP, ACLK1, LFRELOAD, 15'h7FFF, SOUT[14:0]);
// PLA
wire [5:0]PLA;
wire [4:0]PAL_PLA;
wire [4:0]NTSC_PLA;
...
R_COUNTER FRQCNT[10:0] (Clk, ACLK1, 1'b0, {FQCout[9:0], 1'b1},       Reset, FQLOAD, FQSTEP, F[10:0], FQCNT[10:0], FQCout[10:0]);
R_COUNTER DUTCNT[2:0]  (Clk, ACLK1, 1'b0, {DUCout[1:0], FQCout[10]}, Reset, 1'b0,   FQLOAD, 3'b000,  DUCNT[2:0],  DUCout[2:0]);
R_COUNTER SWPCNT[2:0]  (Clk, ACLK1, 1'b0, {SWCout[1:0], 1'b1},       Reset, SWLOAD, SWSTEP, P[2:0],  SWCNT[2:0],  SWCout[2:0]);
...
// TRIANGLE COUNTERS
//                      Clk   F2    DIR           C_IN         Reset  LOAD    STEP    DATA      CNT_OUT      C_OUT
R_COUNTER FRQCNT[10:0] (Clk, PHI1,  1'b0, {TFCout[9:0], 1'b1}, Reset, TFLOAD, TFSTEP, FR[10:0], TFCNT[10:0], TFCout[10:0]);
R_COUNTER LINCNT[6:0]  (Clk, ACLK1, 1'b0, {TLCout[5:0], 1'b1}, Reset, TLLOAD, TLSTEP, LIN[6:0], TLCNT[6:0],  TLCout[6:0]);
R_COUNTER OUTCNT[4:0]  (Clk, PHI1,  1'b1, {TTCout[3:0], 1'b1}, Reset, 1'b0,   TTSTEP, 5'h00,    TTCNT[4:0],  TTCout[4:0]);
// Output
...
//NOISE LFSR
//                         Clk,           SIN,            STEP,  NEXT,   LOAD,    DATA,      SOUT
SHIFT_REG FREQ_LFSR[10:0] (Clk, {FQSOUT[9:0], NLFSR_IN}, NFSTEP, ACLK1, NFLOAD, NNF[10:0], FQSOUT[10:0]);
SHIFT_REG RAND_LFSR[14:0] (Clk, {RSOUT[13:0], RLFSR_IN}, NFLOAD, ACLK1, 1'b0,   15'h0000,  RSOUT[14:0]);
...
//DPCM FREQ LFSR
//                            Clk,           SIN,              STEP,  NEXT,   LOAD,   DATA,      SOUT
SHIFT_REG DMC_FREQ_LFSR[8:0] (Clk, {DLFSROUT[7:0], DLFSR_IN}, DFSTEP, ACLK1, DFLOAD, LP[8:0], DLFSROUT[8:0]);
...
// DPCM COUNTERS
//                      Clk   F2    DIR           C_IN             Reset  LOAD    STEP                 DATA            CNT_OUT         C_OUT
R_COUNTER SBCCNT[2:0]  (Clk, ACLK1, 1'b1, {DMCSBCout[1:0],  1'b1}, Reset, 1'b0,   DFLOAD, 3'b000,                      DMCSBCNT[2:0],  DMCSBCout[2:0]);
R_COUNTER ADRCNT[14:0] (Clk, ACLK1, 1'b1, {DMCACout[13:0],  1'b1}, Reset, DSLOAD, DSSTEP, {1'b1, DMC_ADR[7:0], 6'h00}, DMC_A[14:0],    DMCACout[14:0]);
R_COUNTER  SLCNT[11:0] (Clk, ACLK1, 1'b0, {DMCSLCout[10:0], 1'b1}, Reset, DSLOAD, DSSTEP, {DMC_LEN[7:0], 4'h0},        DMCSLCNT[11:0], DMCSLCout[11:0]);
R_COUNTER OUTCNT[5:0]  (Clk, ACLK1, BOUT, {DMCOCout[4:0],   1'b1}, Reset, W4011,  DMSTEP, DB[6:1],                     DMC_OUT[5:0],   DMCOCout[5:0]);
...
// SPRDMA COUNTER
//                     Clk   F2    DIR           C_IN           Reset  LOAD   STEP  DATA   CNT_OUT      C_OUT
R_COUNTER SPRCNT[7:0] (Clk, ACLK1, 1'b1, {SPRACout[6:0], 1'b1}, Reset, W4014, SPRS, 8'h00, SPRA[7:0], SPRACout[7:0]);
...
// LENGTH DOWN COUNTER
//                     Clk   F2    DIR           C_IN         Reset  LOAD   STEP    DATA     CNT_OUT      C_OUT
R_COUNTER LENCNT[7:0] (Clk, ACLK1, 1'b0, {LCCout[6:0], HALT}, Reset, W400x, LCSTEP, LC[7:0], LCNT[7:0], LCCout[7:0]);
// Logics
always @(posedge Clk) begin
...
//                       Clk   F2    DIR           C_IN         Reset  LOAD   STEP    DATA      CNT_OUT     C_OUT
R_COUNTER DECAYCNT[3:0] (Clk, ACLK1, 1'b0, {DCout[2:0],  1'b1}, Reset, RLOAD, RSTEP, VOL[3:0], DDCNT[3:0], DCout[3:0]);
R_COUNTER ENVELCNT[3:0] (Clk, ACLK1, 1'b0, {ENCout[2:0], 1'b1}, Reset, ERES,  ESTEP, EIN,      ENV[3:0],   ENCout[3:0]);
// Output
